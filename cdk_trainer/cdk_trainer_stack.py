...
class CdkTrainerStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        get_Trainer_resolver.add_dependency(api_schema)
        ...
        get_all_trainers_resolver.add_dependency(api_schema)
        ...
        create_trainers_resolver.add_dependency(api_schema)
        ...
        update_trainers_resolver.add_dependency(api_schema)
        ...
        delete_trainer_resolver.add_dependency(api_schema)
